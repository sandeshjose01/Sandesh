...
function TextRotator() {
  ...
  >
    ...
    I am a Graphic Designer &
      <span
        className="inline-flex ml-1 flex-col h-[calc(theme(fontSize.lg)*theme(lineHeight.tight))] sm:h-[calc(theme(fontSize.3xl)*theme(lineHeight.tight))] overflow-hidden"
      >
        <ul
